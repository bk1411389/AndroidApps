...
public class MainActivity extends ActionBarActivity {
    ...
    private void makeQuestions() {
        // TODO [03] ここから
        Question q1 = new Question(R.drawable.japan, "日本の首都は？","東京","大阪","京都");
        Question q2 = new Question(R.drawable.japan, "一番大きな都道府県は？","北海道","長野","岡山");
        Question q3 = new Question(R.drawable.japan, "一番小さな都道府県は？","香川","東京","佐賀");
        ...
        Question q6 = new Question(R.drawable.dori, "これを書いたのは？","大川ぶくぶ","ドリ","ダリ");
    ...
    private void nextQuestion() {
        ...
        status.setText(String.valueOf(current) + "問中"
                        + String.valueOf(question_num) + "問正解"
                        + String.valueOf(question_num - current) + "問");
        ...
        String[] choice_text = current_question.getChoices();
        button1.setText(choice_text[0]);
        button2.setText(choice_text[1]);
        button3.setText(choice_text[2]);
